  ...
  SplitHunkRow: vi.fn(
    ({
      ...
      <tr
        ...
        onMouseUp={onRowSelectionEnd}
      >
        <td data-testid="split-hunk-row-content">Split Hunk Row Content</td>
      </tr>
    ),
  ),
}))

vi.mock('./UnifiedHunkRow', () => ({
  UnifiedHunkRow: vi.fn(
    ({
      idx,
      _line,
      _viewModel,
      ...
      <tr
        ...
        onMouseUp={onRowSelectionEnd}
      >
        <td data-testid="unified-hunk-row-content">Unified Hunk Row Content</td>
      </tr>
    ),
  ),
}))
...
const createDiffRowProps = createPropsFactory<DiffRowProps>({
  idx: 0,
...
describe('DiffRow', () => {
  ...
  describe('rendering scenarios', () => {
    it.each([
      ...
      { unified: false, isHunk: true, expectedRow: 'split-hunk-row', desc: 'split hunk row' },
      { unified: true, isHunk: true, expectedRow: 'unified-hunk-row', desc: 'unified hunk row' },
    ])(
  ...
  describe('edge cases', () => {
    ...
    it('given hunk line, when rendered, expect hunk row component used', () => {
      // GIVEN
    ...
    it('given unified hunk line, when rendered, expect unified hunk row component used', () => {
      // GIVEN
      const hunkLine = createMockDiffLineViewModel({ typeLeft: 'hunk', typeRight: 'hunk' })
