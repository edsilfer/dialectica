...
export class LineDiff {
  ...
  static build(rawLine: {
    ...
    switch (rawLine.type) {
      case 'add':
        return new LineDiff(content, 'add', lineNumberOld, lineNumberNew)
      case 'del':
        return new LineDiff(content, 'delete', lineNumberOld, lineNumberNew)
      case 'normal':
        return new LineDiff(content, 'context', lineNumberOld, lineNumberNew)
      default:
