 ...
 * @returns           A mock LineDiff with default values and optional overrides
 */
export const createMockLineDiff = (overrides: Partial<DiffLine> = {}): DiffLine => ({
  content: 'test line',
  type: 'context',
  lineNumberOld: 1,
  lineNumberNew: 1,
...
export const HEADER_ONLY_CHANGES: DiffLine[] = [createLineDiff('@@ -100,2 +100,2 @@ lone header', 'context', 100, 100)]

// Sample data with shuffled changes
export const SHUFFLED_CHANGES: DiffLine[] = [
