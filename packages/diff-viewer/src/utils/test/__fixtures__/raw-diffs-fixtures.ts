...
// React Flight Server diff with multiple hunks for testing hunk directions
export const REACT_FLIGHT_SERVER_DIFF = `diff --git a/packages/react-server/src/ReactFlightServer.js b/packages/react-server/src/ReactFlightServer.js
...
export const REACT_FLIGHT_CLIENT_DIFF = `
