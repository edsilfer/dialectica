...
type SettingType = 'switch' | 'checkbox' | 'input' | 'select'
...
interface SwitchSettingProps extends BaseSettingProps<'switch', boolean> {
  /** The current state of the switch */
  checked: boolean
}

interface CheckboxSettingProps extends BaseSettingProps<'checkbox', boolean> {
  /** The current state of the checkbox */
  checked: boolean
}

interface InputSettingProps extends BaseSettingProps<'input', string> {
...
interface SelectSettingProps extends BaseSettingProps<'select', string> {
